...
const transport = new StreamableHTTPClientTransport(new URL(`${process.env.MCP_ENDPOINT}/mcp` || "http://localhost:3001/mcp"));
...
`;
    ...
    finalReply = response.messages[agentLength - 1].content;
